export default () => ({
  ...
  omega: {
    defaultAdminEmail: process.env.OMEGA_ADMIN_EMAIL || 'masteradmin@auroramy.com',
    defaultAdminPassword: process.env.OMEGA_ADMIN_PASSWORD || 'Abcd1234',
    defaultSupportEmail: process.env.OMEGA_SUPPORT_EMAIL || 'superadmin@auroramy.com',
